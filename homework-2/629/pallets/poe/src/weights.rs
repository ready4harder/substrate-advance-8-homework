...
//! HOSTNAME: `MacBook-Pro-99.local`, CPU: `<UNKNOWN>`
...
pub trait WeightInfo {
	fn create_claim_benchmark(c: u32, ) -> Weight;
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_claim_benchmark(_c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `6`
		//  Estimated: `3521`
		// Minimum execution time: 11_000_000 picoseconds.
		Weight::from_parts(12_313_559, 3521)
	...
	/// Proof: `PoeModule::Proofs` (`max_values`: None, `max_size`: Some(56), added: 2531, mode: `MaxEncodedLen`)
	/// The range of component `c` is `[1, 3]`.
	fn revoke_claim(_c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `85 + c * (1 ±0)`
		//  Estimated: `3521`
		// Minimum execution time: 12_000_000 picoseconds.
		Weight::from_parts(14_084_745, 3521)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `PoeModule::Proofs` (r:1 w:1)
	/// Proof: `PoeModule::Proofs` (`max_values`: None, `max_size`: Some(56), added: 2531, mode: `MaxEncodedLen`)
	/// The range of component `c` is `[1, 3]`.
	fn transfer_claim(_c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `85 + c * (1 ±0)`
		//  Estimated: `3521`
		// Minimum execution time: 10_000_000 picoseconds.
		Weight::from_parts(10_796_610, 3521)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
