...
./target/production/solochain-template-node benchmark pallet --wasm-execution=compiled --pallet pallet-poe --extrinsic "*"  --steps 20 --repeat 10 --output pallet/poe/src/weights.rs --template .maintain/frame-weight-template.hbs
