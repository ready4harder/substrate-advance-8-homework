...
mod erc20 {
    ...
    mod e2e_tests {
        ...
        async fn e2e_transfer<Client: E2EBackend>(mut client: Client) -> E2EResult<()> {
            ...
            let erc20 = client.instantiate("erc20", &ink_e2e::alice(), &mut constructor)
                .submit()
                .await
            ...
            let total_supply_res = client.call(&ink_e2e::bob(), &total_supply_msg)
                .dry_run()
                .await?;
            ...
            let _transfer_res = client.call(&ink_e2e::alice(), &transfer)
                .submit()
                .await
                .expect("transfer failed");

            let balance_of = call_builder.balance_of(bob_account);
            let balance_of_res = client.call(&ink_e2e::alice(), &balance_of)
                .dry_run()
                .await?;
