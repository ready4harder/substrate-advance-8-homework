...
mod dispatches {
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn create(origin: OriginFor<T>) -> DispatchResult {
            ...
            let value = Self::generate_random_value(&who);
        ...
        pub fn breed(origin: OriginFor<T>, kitty_id_1: u32, kitty_id_2: u32) -> DispatchResult {
            ...
            let value = Self::combine_kitties(&who, kitty_1, kitty_2);
            Self::mint_kitty(&who, value)?;
            Ok(())
        }
        ...
        pub fn bid(origin: OriginFor<T>, kitty_id: u32, price: BalanceOf<T>) -> DispatchResult {
            ...
            let last_bid = KittiesBid::<T>::try_get(kitty_id)
                .map_err(|_| Error::<T>::KittyNotOnSale)?;
